<section class="masthead .bg-secondary.bg-gradient bg-opacity-25 text-center" >
    <div class="container d-flex  flex-column">
               
                <h2 class="page-section-heading text-center text-uppercase mb-0">Login</h2>
               
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        <form action="php/usuario/verificarLogin.php"  id="contactForm" method="post" data-sb-form-api-token="API_TOKEN">
