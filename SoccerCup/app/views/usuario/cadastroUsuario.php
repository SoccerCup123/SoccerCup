    ...
    <div class="container d-flex  flex-column">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        <form action="php/usuario/usuariocadastro.php"  id="contactForm" method="post" data-sb-form-api-token="API_TOKEN">
                            <div class="form-floating mb-3">
                                <input class="form-control" id="name" name="name" type="text" placeholder="Seu user.."  required />
